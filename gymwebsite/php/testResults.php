...
<html>
    <head>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-white menu">
                    ...
                    <form method="POST" action="logout.php">
                                    <button type="submit" class="btn btn-lg btn-default lr-btn">
                                        <i class="fa fa-edit">Logout<?php echo$_SESSION["Time"]?></i>
                                    </button>
                    </form>
                                </a>
        ...
        <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo$row["id"]?>">Delete</button>
            ...
            <h5 class="modal-title" id="exampleModalLabel">View results</h5>
        ...
        <div class="mb-3 row">
            <label for="Time" class="col-sm-2 col-form-label">Day</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="text" name="Mood" class="form-control" value="<?php echo$row["Nutrition"]?>">
            </div>
        </div>
        ...
        <!-- Modal -->
                <div class="modal fade" id="updateModal<?php echo$row["id"]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Update[<?php echo$row["Time"]?>]</h5>
        ...
        <div class="mb-3 row">
            <label for="email" class="col-sm-2 col-form-label">Day</label>
            <div class="col-sm-10">
            <input type="email" class="form-control" name="Day" value="<?php echo$row["Day"]?>">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            <label for="phone" class="col-sm-2 col-form-label">Session</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" name="Session" value="<?php echo$row["Session"]?>">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            <label for="password" class="col-sm-2 col-form-label">Experience</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            <label for="Nutrition" class="col-sm-2 col-form-label">Nutrition</label>
            <div class="col-sm-10">
            <input type="text" name="Nutrition" class="form-control" value="<?php echo$row["Nutrition"]?>">
            </div>
        </div>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <form method="POST" action="insertData.php">
                        ...
                        <div class="mb-3 row">
                            <label for="Nutrition" class="col-sm-3 col-form-label">Nutrition</label>  
                            <div class="col-sm-9">
                            <input type="text" name="Nutrition" class="form-control">
                            </div>
                        </div>
